...
**ВНИМАНИЕ:** при использовании нескольких (более чем одного) алгоритмов сравнения, итоговый результат, демонстрирующий сходство работ, является средним арифметическим всех результатов используемых алгоритмов.
____
